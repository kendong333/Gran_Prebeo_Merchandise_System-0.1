            ...
            <div class="col-md-10 main-content">
                ...
                <div class="row g-3 filters mt-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Search by tracking ID or customer" disabled>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="card mt-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-warning btn-sm text-white" disabled>
